...
static const char *fonts[] = {  "OperatorMono Nerd Font:size=10:style=bold:antialias=true:autohint=true",
...
const char *spcmd2[] = {"st",     "-n", "spfm",   "-g", "156x42", "-e", "ranger", NULL};
...
const char *spcmdA[] = {"st",     "-c", "sphtop", "-g", "156x42", "-e", "htop",   NULL};
const char *spcmdB[] = {"st",     "-c", "splvim", "-g", "156x72", "-e", "lvim",   NULL};
...
static char *tagicons[][NUMTAGS] = {
          [DEFAULT_TAGS]          =     {"一", "二", "三", "四", "五"},       // , "6", "7", "8", "9"},
...
static const Rule rules[] = {
    ...
    RULE(.class = "sphtop", .tags = SPTAG(9), .isfloating = 1)
    RULE(.class = "splvim", .tags = SPTAG(10), .isfloating = 1)
...
static const char *dmenucmd2[] = {"rofi", "-show", "drun", "-theme", "~/.config/rofi/themes/launcher.rasi", NULL};
...
static Key keys[] = {
    ...
    {A,     XK_s, togglescratch, {.ui = 6}},
    {A,     XK_d, togglescratch, {.ui = 7}},
    {A,     XK_m, togglescratch, {.ui = 8}},
    {A,     XK_h, togglescratch, {.ui = 9}},
    {A|S,   XK_v, togglescratch, {.ui = 10}},
    ...
    {0, PrintScreenDWM,          spawn, SHCMD("~/.config/rofi/bin/screenshot")},
